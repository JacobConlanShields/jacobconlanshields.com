...
CREATE INDEX IF NOT EXISTS idx_media_collection_public_sort
...
CREATE INDEX IF NOT EXISTS idx_multipart_status ON multipart_uploads(status, updated_at DESC);
