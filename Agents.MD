...
- `/admin/upload` now restores destination-aware per-file metadata fields (Title + Location/Description), including slide-in field animations, per-file removal, and per-item upload state feedback.
