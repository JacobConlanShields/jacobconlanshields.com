...
- Purpose: prototype an interactive flowchart workspace where users load a YouTube playlist into a video bank, drag videos onto a whiteboard, add text boxes, and connect nodes with arrows.
