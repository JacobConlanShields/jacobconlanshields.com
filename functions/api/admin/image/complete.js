import { badRequest, handleOptions, json, mediaUrl, nowIso, requireAdmin, uuid, withCors } from "../../../_lib/media.js";
...
export async function onRequest({ request, env }) {
  ...
  if (!collection || !r2Base || !key) return withCors(badRequest("Missing collection/r2Base/key"));
